...
namespace VampEditor.Language
{
    ...
    {
        private const String CPP_STD_COMMON_CLASSES_STRUCTS = "string vector rotl rotr pair tuple map set list array deque queue stack priority_queue forward_list unordered_map unordered_set unordered_multimap unordered_multiset multimap multiset iterator function unique_ptr shared_ptr weak_ptr atomic mutex condition_variable";
