namespace VampirioCode.UI.Controls
{
   ...
   public class ScrollBarAdv : Control
   {
        ...
        [Browsable(true)]
        public Color ThumbNormalColor { get; set; } = Color.FromArgb(130, 130, 130);

        [Localizable(true)]
        [Category("Extra Properties")]
        [Description("Thumb Over Color")]
        [Browsable(true)]
        public Color ThumbOverColor { get; set; } = Color.FromArgb(120, 120, 120);

        [Localizable(true)]
        [Category("Extra Properties")]
        [Description("Thumb Down Color")]
        [Browsable(true)]
        public Color ThumbDownColor { get; set; } = Color.FromArgb(100, 100, 100);

        [Localizable(true)]
        [Category("Extra Properties")]
        [Description("Button Normal Color")]
        [Browsable(true)]
        public Color ButtonNormalColor { get; set; } = Color.FromArgb(70, 70, 70);

        [Localizable(true)]
        [Category("Extra Properties")]
        [Description("Button Over Color")]
        [Browsable(true)]
        public Color ButtonOverColor { get; set; } = Color.FromArgb(140, 140, 140);

        [Localizable(true)]
        [Category("Extra Properties")]
        [Description("Button Down Color")]
        [Browsable(true)]
        public Color ButtonDownColor { get; set; } = Color.FromArgb(120, 120, 120);

        [Localizable(true)]
        [Category("Extra Properties")]
        [Description("Track Color")]
        [Browsable(true)]
        public Color TrackColor { get; set; } = Color.FromArgb(110, 110, 110);
        ...
        [Browsable(true)]
        public Color BackgroundColor { get; set; } = Color.FromArgb(70, 70, 70);

        [Localizable(true)]
        [Category("Extra Properties")]
        [Description("Border Color")]
        [Browsable(true)]
        public Color BorderColorAdv { get; set; } = Color.Black;
      ...
      public int Value
      {
        ...
        {
            get { return this.Value / (double)this.Maximum; }
        }
      ...
      protected override void OnPaint(PaintEventArgs e)
      {
         ...
         Renderer.DrawBackground(e.Graphics, ClientRectangle, this.orientation);

         // draws the track
         Renderer.DrawTrack(e.Graphics, rect, ScrollBarState.Normal, this.orientation);

         // draw thumb and grip
         Renderer.DrawThumb(e.Graphics, this.thumbRectangle, this.thumbState, this.orientation);

         //if (this.Enabled)
         //{
         //   Renderer.DrawThumbGrip(e.Graphics, this.thumbRectangle, this.orientation);
         //}

         // draw arrows
         Renderer.DrawArrowButton(e.Graphics, topArrowRectangle, topButtonState, true, orientation);
         Renderer.DrawArrowButton(e.Graphics, bottomArrowRectangle, bottomButtonState, false, orientation);
         ...
         if (this.topBarClicked)
         {
            ...
            Renderer.DrawTrack(e.Graphics, this.clickedBarRectangle, ScrollBarState.Pressed, this.orientation);
         }
         else if (this.bottomBarClicked)
         {
            ...
            // draw border
            //using (Pen pen = new Pen((this.Enabled ? this.borderColor : this.disabledBorderColor)))
            //{
            ...
            if (BordersVisible)
            {
                if(Enabled) bordersColor = BorderColorAdv;
                else        bordersColor = BorderColorDisabled;  
            }
            else
            {
            ...
            e.Graphics.DrawRectangle(new Pen(bordersColor), 0, 0, this.Width - 1, this.Height - 1);
        }
      ...
      private void SetUpScrollBar()
      {
         ...
         if (this.orientation == ScrollBarOrientation.Vertical)
         {
            ...
            this.thumbRectangle = new Rectangle(
               ClientRectangle.X,        //ClientRectangle.X + 2,
               ClientRectangle.Y + this.arrowHeight + 1,         //ClientRectangle.Y + this.arrowHeight + 1,
               this.Width,      //this.thumbWidth - 1,
               this.thumbHeight      //this.thumbHeight
            );

            this.topArrowRectangle = new Rectangle(
               ClientRectangle.X,       //ClientRectangle.X + 2,
               ClientRectangle.Y,       //ClientRectangle.Y + 1,
               this.Width,              //this.arrowWidth,
               this.arrowHeight + 1     //this.arrowHeight
            );

            this.bottomArrowRectangle = new Rectangle(
               ClientRectangle.X,       //ClientRectangle.X + 2,
               ClientRectangle.Bottom - this.arrowHeight - 1,   //ClientRectangle.Bottom - this.arrowHeight - 1,
               this.Width,              //this.arrowWidth,
               this.arrowHeight + 1     //this.arrowHeight
            );
         ...
         else
         {
            ...
            this.thumbRectangle = new Rectangle(
               ClientRectangle.X + this.arrowWidth + 1,          //ClientRectangle.X + this.arrowWidth + 1,
               ClientRectangle.Y,            //ClientRectangle.Y + 2,
               this.thumbWidth,          //this.thumbWidth,
               this.Height          //this.thumbHeight - 1
            );

            this.topArrowRectangle = new Rectangle(
               ClientRectangle.X,       //ClientRectangle.X + 1,
               ClientRectangle.Y,       //ClientRectangle.Y + 2,
               this.arrowWidth + 1,         //this.arrowWidth,
               this.Height         //this.arrowHeight
            );

            this.bottomArrowRectangle = new Rectangle(
               ClientRectangle.Right - this.arrowWidth - 1,     //ClientRectangle.Right - this.arrowWidth - 1,
               ClientRectangle.Y,   //ClientRectangle.Y + 2,
               this.arrowWidth + 1,     //this.arrowWidth,
               this.Height     //this.arrowHeight
            );
