...
{
    public partial class CustomClangCppBuilderSetting : CustomCppBuilderSettingBase
    {
        private CustomClangBuilder builder;

        public CustomClangCppBuilderSetting()
        {
            InitializeComponent();
        }
        ...
        {
            builder = (CustomClangBuilder)CustomBuilders.GetBuilder(fullFilePath, builderType);
            builder.Prepare();
            builder.Load();
        ...
        private void OnSaveData()
        {
            ...
            settings.OutputType =           GetComboBoxEnum<Command.Clang.Params.OutputType, OutputTypeInfo>(outputTypeCBox, "GetByName");
