...
{
    public partial class CustomEmscriptenCppBuilderSetting : CustomCppBuilderSettingBase
    {
        private CustomEmscriptenBuilder builder;

        public CustomEmscriptenCppBuilderSetting()
        {
            InitializeComponent();
        }
        ...
        {
            builder = (CustomEmscriptenBuilder)CustomBuilders.GetBuilder(fullFilePath, builderType);
            builder.Prepare();
            builder.Load();
        ...
        private void OnSaveData()
        {
            ...
            settings.OutputType =           GetComboBoxEnum<Command.Emscripten.Emcc.Params.OutputType, OutputTypeInfo>(outputTypeCBox, "GetByName");
